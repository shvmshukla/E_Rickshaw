...
<div id="navigation">
 ...
 %>
       ...
       <form action="cancelservlet.jsp" >
    	    <table  align="center" bgcolor="white" cellspacing="5" cellpadding="10">
               		
					<tr><td><h4>Enter your details:(exactly in the same manner as u entered at the time of booking rickshaw)</h4></td></td></tr>
					...
					<tr><td>NAME:</td><td> <input type="text" name="cname" required="enter"</td></tr>
                                        ...
                                        <tr><td>DRIVER NAME:</td><td> <input type="text" name="dname"   border="0" /> </td></tr>
                                        <tr><td>RICKSHAW NO:</td><td> <input type="text" name="rickshawno" /></td></tr>
                                        
                                         
					<tr><td><input type="submit" value="cancel booking" name="click"</td><td><input type="reset" value="reset"</td></tr>
